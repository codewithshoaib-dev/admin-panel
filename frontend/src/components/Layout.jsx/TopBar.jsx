...
const TopBar = ({ onToggleSidebar }) => {
    ...
    toast.custom((t) => (
      ...
      >
        <div className="flex flex-col">
          <span className="font-semibold text-base">Confirm Logout?</span>
  ...
  return (
    <header className="h-16 flex items-center justify-between px-6 bg-indigo-600 border-b border-neutral-800 md:ml-64">
   
      <div className="flex items-center gap-4">
        <button
          className="md:hidden text-xl p-2 rounded-lg bg-indigo-600 text-white"
      ...
      <div className="flex items-center gap-4">
        <span className="text-md text-neutral-300">{user?.username || "Guest"}</span>
        <button
