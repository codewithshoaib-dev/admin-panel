...
const SideBar = ({ open, setOpen }) => {
  ...
  const isActive = (path) => location.pathname === path;
    ...
    <>
      ...
      <AnimatePresence>
        {open && (
          <motion.aside
            ...
            className="fixed top-0 left-0 h-full w-64 bg-neutral-900 text-neutral-100 shadow-2xl z-50 md:hidden"
          >
      ...
      <aside className="hidden md:block w-64 h-screen bg-neutral-900 text-neutral-100 shadow-2xl fixed top-0 left-0">
...
const SidebarContent = ({ onClose, isActive }) => (
  <div className="flex flex-col h-full">
    ...
    <div className="p-4 text-xs text-neutral-500 border-t border-neutral-700">
      &copy; 2025 My SaaS
    </div>
  </div>
)
